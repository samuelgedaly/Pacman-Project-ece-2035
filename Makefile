...
OBJECTS += doubly_linked_list.o
OBJECTS += ghost.o
OBJECTS += main.o
OBJECTS += map/map.o
OBJECTS += pacman.o
OBJECTS += wave_player/vector.o
...
AS      = 'arm-none-eabi-gcc' '-x' 'assembler-with-cpp' '-c' '-Wall' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-mcpu=cortex-m3' '-mthumb'
CC      = 'arm-none-eabi-gcc' '-std=gnu99' '-c' '-Wall' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-mcpu=cortex-m3' '-mthumb'
CPP     = 'arm-none-eabi-g++' '-std=gnu++98' '-c' '-Wall' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-mcpu=cortex-m3' '-mthumb'
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1492483520.04
C_FLAGS += -DTARGET_M3
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1492483520.04
